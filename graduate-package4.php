...
<head>
    ...
    <link rel="stylesheet" href="css/graduate-package4.css">
            ...
            <div class="row">
                ...
                <div class="col frames">
                    ...
                    <div class="d-flex py-2">
                        <h1 class="px-2">1x</h1>
                        <h6>12" x 18" <br> Double Glass Frame</h6>
                    </div>
                    <div class="d-flex py-2">
                        <h1 class="px-2">4x</h1>
                    ...
                    <div class="d-flex py-2">
                        <h1 class="px-2">8x</h1>
                        <h6>5" x 7" <br> Printed Copy</h6>
                    </div>
                    <div class="d-flex py-2">
                        <h1 class="px-2">12x</h1>
                ...
                <div class="col forms">
                    ...
                    <form id="appointmentForm" action="">
                        <input type="text" name="package" value="GRADUATE Package 4" hidden>
