...
<head>
    ...
    <link rel="stylesheet" href="css/graduate-package1.css">
            ...
            <div class="row">
                ...
                <div class="col forms">
                    ...
                    <form id="appointmentForm" action="">
                        <input type="text" name="package" value="GRADUATE Package 1" hidden>
