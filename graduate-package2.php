...
<head>
    ...
    <link rel="stylesheet" href="css/graduate-package2.css">
    ...
    <section class="pricing">
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="col-sm frames">
                    <div class="text-center">
                        <h1 class="py-2">With Frame</h1>
                    </div>
                    <div class="d-flex py-2">
                        <h1 class="px-2">1x</h1>
                        <h6>8" x 10" <br> Double Glass Frame</h6>
                    </div>
                    <div class="d-flex py-2">
                        <h1 class="px-2">2x</h1>
                ...
                <div class="col-sm ">
                    <div class="forms">
                        ...
                        <form id="appointmentForm" action="">
                            <input type="text" name="package" value="GRADUATE Package 2" hidden>
                            ...
                            <div class="date-time">
                                ...
                                <div class="input-group">
                                    <input type="time" name="time" min="08:00" max="17:00" autocomplete="off"
                                        class="input">
                    ...
                    if (result.success) {
                        ...
                        modalContent.innerHTML = `
                            <div class=\"mt-3\">
                                ...
                                <p><strong>Price:</strong> ₱1,599.00</p>
                            </div>
                        `;
