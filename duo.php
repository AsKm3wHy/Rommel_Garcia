...
// Database configuration (match solo.php style)
class Database {
    private $host;
    private $db_name;
    private $username;
            ...
            <div class="row">
                ...
                <div class="col" style="border: 1px solid #dbdbdb; border-radius: 10px;">
                    ...
                    <form id="appointmentForm" action="">
                        <input type="text" name="package" value="DUO" hidden>
